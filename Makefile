...
build-musl-aux build-musl-cov-aux:
	cmake -B .musl-build \
		...
		-DRust_COMPILER=/root/.rustup/toolchains/1.74.0-$(ARCH)-unknown-linux-musl/bin/rustc \
		-DRust_CARGO=/root/.rustup/toolchains/1.74.0-$(ARCH)-unknown-linux-musl/bin/cargo \
