...
struct block_resp {
  ...
  struct accept_entry_iter {
    ...
    accept_entry_iter(const ngx_str_t &header, std::size_t pos = 0)
...
blocking_service *blocking_service::instance;

void blocking_service::initialize(std::string_view templ_html,
