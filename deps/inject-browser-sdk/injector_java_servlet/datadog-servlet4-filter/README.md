...
* Java 8+
* Servlet API 3.0-4.0.1
* Maven 1.8

## Compatibility

* Apache Tomcat 7.0.x-9.0.x ([compatibility reference](https://tomcat.apache.org/whichversion.html))

## Usage

Build the filter JAR using Maven, and copy the `java-servlet4-filter-<version>-jar-with-dependencies.jar` into the `lib` folder of your Tomcat installation:
```shell
./mvn package
cp datadog-servlet4-filter-<version>-jar-with-dependencies.jar <tomcat-install-dir>/lib/
```
