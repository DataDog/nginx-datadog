...
def get_patch_directory(version: str, ingress_rootdir: str) -> str:
    mapping = {
        "v1.15.0": f"{ingress_rootdir}/images/nginx/rootfs/patches",
        "v1.14.4": f"{ingress_rootdir}/images/nginx/rootfs/patches",
        ...
        "v1.13.8": f"{ingress_rootdir}/images/nginx/rootfs/patches",
