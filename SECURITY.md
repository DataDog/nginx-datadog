# Datadog Nginx Module Security Policy

This document outlines the security policy for the Datadog Nginx module and what to do if you
...
release](https://github.com/DataDog/nginx-datadog/releases).
